...
for team in team_player_dict.keys():
    ...
    print(selected_players[['player_id', 'normalised_performance_score', 'market_value_in_eur']])


#Output for the optiguide to be entered here


#1.Player to be included - constraints to be changed/data to be manipulated
#9 player categorical budgeting - constraint modification
#not sure how to do 8: why did we select player X over player Y- maybe comparing stats?
#I am not sure if question 10 is feasible